...
public:
    ...
    void viewImage(QImage* myImage); //This function is called by the windows GUI.  It returns the image in format the GUI understands.


private:
    void pixelsToQImage(QImage* myImage); //this function is called internally by the image class.
